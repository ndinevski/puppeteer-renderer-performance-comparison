...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{layer-structure.png}
\caption{Code architecture view}
...
\begin{table}[h]
\centering
\begin{tabular}{|>{\raggedright\arraybackslash}p{2.8cm}|>{\raggedright\arraybackslash}p{4.7cm}|}
\hline
{}\textbf{Change Category} & \textbf{Update Required} \\
\hline
Cloud target & \url{renderer-infrastructure:cloud} \\
Location & \url{aws:region} or \url{azure-native:location} \\
...
The complete source code, infrastructure definitions, and paper artifacts are available in the GitHub repository:\\
\href{https://github.com/ndinevski/puppeteer-renderer-performance-comparison/blob/master/infrastructure/README.md}{\underline{GitHub project infrastructure README}}.
